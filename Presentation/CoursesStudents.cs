...
{
    public partial class CoursesStudent : Form
    {
        ...
        private void GetStudentName()
        {
            ...
            Cmd.Parameters.AddWithValue("@StID", IdCb.SelectedValue.ToString());
            DataTable dt = new DataTable();
        ...
        private void DisplayAttendance()
        {
            ...
            var ds = new DataSet();
            sda.Fill(ds);
            CoursesStudentsDGV.DataSource = ds.Tables[0];
            Con.Close();
        }
        ...
        private void AddBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    SqlCommand cmd = new SqlCommand("insert into AlunosTurmas(AlunoId,CursoNome,TurmaNome) values (@AlunoId,@CursoNome,@TurmaNome)", Con);
                    ...
                    cmd.Parameters.AddWithValue("@TurmaNome", classNameTb.SelectedValue.ToString());
                    cmd.ExecuteNonQuery();
        ...
        private void EditBtn_Click(object sender, EventArgs e)
        {
            try
            {
                db.atualizarTurmasAlunos(IdCb.SelectedValue.ToString(),classNameTb.SelectedItem.ToString(), courseNameTb.SelectedItem.ToString(), CourseStudentID);
                var data = db.ProfessorAssiduidades.Single(x => x.Id == CourseStudentID);
        ...
        {
            // TODO: This line of code loads data into the 'mSDOCSCHOOLDataSetCursosAlunos.AlunosTurmas' table. You can move, or remove it, as needed.
        }
        private void searchTxt_TextChanged(object sender, EventArgs e)
        {
            CoursesStudentsDGV.DataSource = coursesStudent.searchCourseStudents(searchTxt.Text);
        }
        ...
        private void DeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    SqlCommand cmd = new SqlCommand("delete from AlunosTurmas where Id = @StCourseKey", Con);
                    cmd.Parameters.AddWithValue("@StCourseKey", Key);
                    cmd.ExecuteNonQuery();
        ...
        private void CoursesTeachersDGV_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                DataGridViewRow row = CoursesStudentsDGV.Rows[e.RowIndex];
                CourseStudentID = Convert.ToInt32(row.Cells[1].Value.ToString());
                IdCb.SelectedValue = Convert.ToInt32(row.Cells[2].Value.ToString());
                classNameTb.Text = row.Cells[3].Value.ToString();
                courseNameTb.Text = row.Cells[4].Value.ToString();
                DataTable dt = CoursesStudentsDGV.DataSource as DataTable;
                GetStudentName();
                if (TNameTb.Text == "")
                {
                    Key = 0;
